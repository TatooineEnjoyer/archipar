...
const cases = [
  ...
  {
    title: "Хамам как часть закрытой зоны восстановления тела",
    type: "Интегрированный блок · Репино",
    image: "/images/cases/case-02.jpg",
    size: "small",
  },
  {
    title: "Парная с персональными сценариями климата",
...
const typologies = [
  ...
  {
    title: "Пространства для души и тела",
  ...
  {
    title: "Коммерческие & Гостевые зоны",
...
const methodSteps = [
  {
    ...
    text: "Анализируем проект здания, объем доступных мощностей, антропометрию и персональные ритуалы отдыха будущих владельцев.",
    icon: Compass,
  },
  {
    title: "Проектирование и генерация сред",
    text: "Создаем первичный проект: связываем дизайн-концепцию, раскладку камня/дерева и разводку сложных инженерных трасс в единую модель.",
    icon: Ruler,
  },
  {
    title: "Комплектация и полный монтаж",
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_320px] lg:items-end">
            <div>
              ...
              <div className="mt-10 flex flex-col gap-4 sm:flex-row">
                <Link
                  href="#request"
                  className="inline-flex items-center justify-center gap-3 border border-white/20 bg-white px-8 py-4 text-xs font-semibold uppercase tracking-widest text-black transition-all hover:bg-[#c8aa78]"
                >
                  Заказать проект
